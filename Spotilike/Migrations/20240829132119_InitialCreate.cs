        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Morceaux_Albums_AlbumId",
                        column: x => x.AlbumId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MorceauxId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MorceauxGenres", x => new { x.GenresId, x.MorceauxId });
                    table.ForeignKey(
                        name: "FK_MorceauxGenres_Genres_GenresId",
                        column: x => x.GenresId,
                        principalTable: "Genres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MorceauxGenres_Morceaux_MorceauxId",
                        column: x => x.MorceauxId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Morceaux_AlbumId",
                table: "Morceaux",
                column: "AlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_MorceauxGenres_MorceauxId",
                table: "MorceauxGenres",
                column: "MorceauxId");
        }
